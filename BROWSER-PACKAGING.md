...
|---|---|---|---|
| `aztec-avm-runtime/browser` — the DD-5 reference | **265.97 KB** | 9 | 253.94 KB |
| `aztec-avm-runtime/testing` | 294.83 KB | 12 | 291.09 KB |
| the demo page | 295.93 KB | 12 | 292.3 KB |
| `aztec-avm-runtime/node` | 225.62 KB | 4 | 223.61 KB |
...
**8,239.78 KB gzipped across every chunk; 265.97 KB is what the reference entry point costs.** That is
...
265.97 KB and it does not reach any of them: an entry point that gains exports changes how
