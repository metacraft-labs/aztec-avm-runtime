...
|---|---|---|---|
| `aztec-avm-runtime/browser` — the DD-5 reference | **266.81 KB** | 9 | 253.94 KB |
| `aztec-avm-runtime/testing` | 295.67 KB | 12 | 291.09 KB |
| the demo page | 296.77 KB | 12 | 292.3 KB |
| `aztec-avm-runtime/node` | 226.47 KB | 4 | 223.61 KB |
...
**8,241.47 KB gzipped across every chunk; 266.81 KB is what the reference entry point costs.** That is
