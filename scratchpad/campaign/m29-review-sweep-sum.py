#!/usr/bin/env python3
"""Summarise a campaign sweep log (M29 REVIEW COPY: the reference carries m29 = 127) — and REFUSE to print a total while a hole is open.

    scratchpad/campaign/m29-sweep-sum.py <sweep.log> [reference.json]
...
REFERENCE = {
    ...
    "m21": 325, "m27": 345, "m28": 353, "m29": 127,
}
