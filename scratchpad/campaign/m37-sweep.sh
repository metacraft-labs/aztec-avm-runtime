#!/usr/bin/env bash
# The M0–M36 sweep, one milestone at a time, in THIS repository's own dev shell.
#
#   setsid nohup direnv exec /home/zahary/m/blocktracer/aztec-avm-runtime \
#       bash scratchpad/campaign/m37-sweep.sh > ~/.cache/aztec-m37-sweep.log 2>&1 < /dev/null &
#
