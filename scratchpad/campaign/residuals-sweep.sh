#!/usr/bin/env bash
# The M0–M37 residuals sweep, one milestone at a time, in THIS repository's own dev shell.
#
#   setsid nohup direnv exec /home/zahary/m/blocktracer/aztec-avm-runtime \
#       bash scratchpad/campaign/residuals-sweep.sh > ~/.cache/aztec-residuals-sweep.log 2>&1 < /dev/null &
#
...
# `residuals-sweep-sum.py` can tell a milestone that ran from one whose output was lost, and REFUSE to
