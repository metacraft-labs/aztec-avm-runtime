#!/usr/bin/env bash
# The M0–M26 sweep, one milestone at a time, in THIS repository's own dev shell.
#
#   setsid nohup direnv exec /home/zahary/m/blocktracer/aztec-avm-runtime \
#       bash scratchpad/campaign/m26-sweep.sh > ~/.cache/aztec-m26-sweep.log 2>&1 < /dev/null &
#
...
# `m26-sweep-sum.py` can tell a milestone that ran from one whose output was lost, and REFUSE to
...
MILESTONES="${MILESTONES:-m0 m1 m2 m3 m4 m5 m6 m7 m8 m9 m10 m11 m12 m13 m14 m15 m16 m17 m18 m19 m20 m21 m22 m23 m24 m25 m26}"
