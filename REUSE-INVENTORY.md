...
- covers: private-execution
- decision: vendor
- milestone: M21 (the decision and the enumeration), the wiring itself is open
...
- rejection-reason: n/a
- confidence: measured
- experiment: n/a for the decision. What is open is the WIRING, and its cost is the oracle surface rather than the simulator: see RI-65.
...
- upstream: `yarn-project/simulator/src/public/fixtures/public_tx_simulation_tester.ts` and its relative-import closure @ anchor `ts`
- covers: test-harnesses
- decision: vendor
- milestone: M25, M26
