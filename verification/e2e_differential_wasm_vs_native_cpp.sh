...
# one that cannot fail, and this campaign has shipped twenty-one assertions that could not.
#
...
# twenty-one-times-over defect this campaign is named for, and it took a full-suite run to see it.
