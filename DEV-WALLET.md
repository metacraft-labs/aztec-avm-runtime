...
upstream's `WASMSimulator` and the whole 68-oracle wire layer, 275.26 -> 296.97 KB and 309.99 ->
334.07 KB, with two more `bumps` entries recording it. `PRIVATE-EXECUTION.md` §6 carries that
